Created a reponsive layout using flex. The content is about restaurant, with a nice carrousel related to the content of my page, the behavior when resizing is similar, it has 3 different layouts.
